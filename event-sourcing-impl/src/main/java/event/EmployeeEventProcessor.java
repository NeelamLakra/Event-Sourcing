...
public class EmployeeEventProcessor extends ReadSideProcessor<EmployeeEvent> {
    ...
    public ReadSideHandler<EmployeeEvent> buildHandler(){
        return readSide.<EmployeeEvent>builder("Employee")
    ...
    private CompletionStage<Done> createTable() {
        return session.executeCreateTable(
                "CREATE TABLE IF NOT EXISTS employee ( " +
                        "name TEXT primary key, salary double, projectName Text)"
        );
    }
    ...
    private void setDeleteEmployee(PreparedStatement statement){
        this.deleteEmployee=statement;
    }
